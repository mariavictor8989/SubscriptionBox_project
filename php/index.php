...
<nav class="navbar navbar-expand-lg sticky-top">
    <div class="container">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="login.html" class="btn-login ms-3">Log in</a>
        </div>
    </div>
</nav>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-4">
                <div class="plan-card">
                    ...
                    <a href="register.html" class="btn btn-outline-success w-100 py-2 fw-bold">Get Started</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="plan-card featured position-relative">
                    ...
                    <a href="register.html" class="btn btn-success w-100 py-2 fw-bold">Get Started</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="plan-card vip-card">
                    ...
                    <a href="register.html" class="btn w-100 py-2 fw-bold" style="background:#ffd700;color:#333;border:none;">Go VIP 👑</a>
                </div>
            </div>
...
<footer>
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-3">
            <a href="login.html" class="text-decoration-none" style="color:#aaa;">Log in</a>
            <a href="register.html" class="text-decoration-none" style="color:#aaa;">Sign up</a>
        </div>
    </div>
</footer>
